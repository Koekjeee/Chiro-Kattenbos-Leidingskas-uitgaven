document.addEventListener("DOMContentLoaded", () => {
  // --- Config ---
  const alleGroepen = ["Ribbels","Speelclubs","Rakkers","Kwiks","Tippers","Toppers","Aspi","Keti","4uurtje","Algemeen","LEIDING"]; // Basale vaste groepen + Keti + 4uurtje + Algemeen
  const groepKleuren = {
